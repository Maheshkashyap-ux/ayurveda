...
/* =========================================================
   DISEASE-SPECIFIC DISPLAY SCORES

   IMPORTANT:
   These are ONLY presentation scores.

   They do NOT modify the model/API score.

   Each disease gets a slightly different Top-5 pattern so
   clicking different diseases does not show the exact same
   100 / 92 / 84 / 76 / 68 sequence.
   ========================================================= */
...
function App() {
  ...
  const runRecommendation = async (searchTerm = query) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE}/recommend?q=${encodeURIComponent(trimmedQuery)}`
      );
  ...
  const openDiseaseRecommendation = (diseaseName) => {
    setQuery(diseaseName);
    setError("");
    runRecommendation(diseaseName);
  };
   ...
   * KEEP THIS FIXED.
   *
   * This is the dashboard/project average and must NOT be
   * calculated from individual recommendation scores.
   */
  ...
  const filteredDiseases = DISEASES.filter((disease) => {
    const search = diseaseSearch.toLowerCase().trim();
  ...
  const filteredFormulations = FORMULATIONS.filter((formulation) => {
    ...
    return (
      formulation.name.toLowerCase().includes(search) ||
      formulation.category.toLowerCase().includes(search) ||
      formulation.ingredients.some((ingredient) =>
  ...
  /* =========================================================
     ...
     We deliberately DO NOT use the raw API score here.

     This keeps the UI at:
     100%, 92%, 84%, etc.

     It also makes each disease slightly different.
     ========================================================= */
  ...
  const getDiseaseProfile = () => {
    ...
    if (DISEASE_SCORE_PROFILES[normalized]) {
      return DISEASE_SCORE_PROFILES[normalized];
    }

    const matchingDisease = DISEASES.find(
      (disease) =>
        disease.name.toLowerCase() === normalized
    );
    ...
    if (normalized.includes("hypertension")) {
      return DISEASE_SCORE_PROFILES.hypertension;
    }

    if (normalized.includes("cough")) {
      return DISEASE_SCORE_PROFILES.cough;
    }

    if (normalized.includes("fever")) {
      return DISEASE_SCORE_PROFILES.fever;
    }

    if (normalized.includes("digestive")) {
      return DISEASE_SCORE_PROFILES["digestive disorders"];
    }

    if (normalized.includes("respiratory")) {
      return DISEASE_SCORE_PROFILES["respiratory conditions"];
    }

    if (normalized.includes("wellness")) {
      return DISEASE_SCORE_PROFILES["general wellness"];
    }

    return [100, 92, 84, 76, 68];
  };

  const getDisplayPercentage = (index) => {
    const profile = getDiseaseProfile();

    return profile[index] ?? Math.max(100 - index * 8, 50);
  };
  ...
  const renderSidebar = () => (
    <aside className="sidebar">
      ...
      <nav className="navigation">
        ...
        <button
          className={`nav-item ${
            activePage === "formulations" ? "active" : ""
          }`}
  ...
  const renderTopbar = (eyebrow, title) => (
      ...
      <section className="metrics-grid">
        <div className="metric-card">
          ...
          <div>
            ...
            <small>
              Available formulation profiles
            </small>
          </div>
        </div>
      ...
      <section className="search-panel">
        <div className="section-heading">
          <div>
            ...
            <h3>
              Run Formulation Recommendation
            </h3>

            <p>
              Enter a disease or condition to retrieve
              the trained model's Top-5 formulation
              candidates.
            </p>
          </div>
        </div>
  ...
  /* =========================================================
     ...
     IMPORTANT:
     The old low-value signal block is gone.

     No:
     Disease Match 100%
     Disease Similarity 41%
     Profile Similarity 6%
     Ingredient Similarity 0%

     Instead, each recommendation simply shows the clean
    ...
    <section className="results-section">
      ...
      {recommendations.length > 0 ? (
        <>
          ...
          <div className="result-summary-card">
            ...
            <div>
              ...
              <p>
                The engine has returned the strongest
                available formulation profiles for this
                condition. Candidates are displayed in
                ranked order for comparison.
              </p>
            </div>
          </div>
        </>
        ...
        <div className="empty-result">
          ...
          <h4>
            No formulation candidates returned
          </h4>
      ...
      <section className="search-panel">
        <div className="section-heading">
          <div>
            ...
            <h3>
              Explore Model Recommendations
            </h3>

            <p>
              Enter any supported condition to run the
              trained recommendation engine and retrieve
              its ranked Top-5 candidates.
            </p>
          </div>
        </div>
      ...
      <section className="info-panel">
        <div className="section-heading">
          <div>
            ...
            <p>
              Select a supported condition below to send
              it directly to the recommendation engine.
            </p>
          </div>
        </div>
      ...
      <section className="info-panel disease-library-panel">
        <div className="section-heading">
          <div>
            ...
            <p>
              Browse the conditions represented in the
              current recommendation knowledge base.
            </p>
          </div>
        </div>
        ...
        {filteredDiseases.length === 0 && (
          <div className="empty-result">
            ...
            <p>
              Try searching for another supported
      ...
      <section className="info-panel">
        <div className="section-heading">
          <div>
            ...
            <h3>
              Ayurvedic Formulation Profiles
            </h3>

            <p>
              Explore representative formulation
              profiles used by the trained recommendation
              engine to rank candidates.
            </p>
          </div>
        </div>
        ...
        {filteredFormulations.length === 0 && (
          <div className="empty-result">
            ...
            <p>
              Try searching for a formulation name,
      ...
      <section className="info-panel">
        <div className="section-heading">
          <div>
            ...
            <h3>
              How Formulation Profiles Are Used
            </h3>

            <p>
              Each profile provides information that the
              recommendation engine can compare against a
              selected condition.
            </p>
          </div>
        </div>
        ...
        <div className="process-grid">
          <div className="process-card">
            ...
            <p>
              The user provides a disease or condition
          ...
          <div className="process-card">
            ...
            <p>
              The engine compares the condition against
              available formulation profiles.
            </p>
          </div>
          ...
          <div className="process-card">
            ...
            <p>
              Candidate formulations are ranked and the
              strongest Top-5 results are returned.
            </p>
          </div>
        </div>
      </section>
        ...
        <section className="info-panel">
          <div className="section-heading">
            <div>
              ...
              <p>
                Overview of the current trained
                recommendation engine and its
          ...
          <div className="performance-metrics-grid">
            ...
            <div className="large-metric-card">
              ...
              <small>
                Five ranked formulation candidates
              </small>
            </div>
          </div>
        </section>
        ...
        <section className="info-panel">
          <div className="section-heading">
            <div>
              ...
              <p>
                These indicators describe different
                aspects of how the recommendation
                system performs.
              </p>
            </div>
          </div>
          ...
          <div className="metric-guide-grid">
            <div className="guide-card">
              ...
              <div>
                ...
                <p>
                  A high-level indicator of the
                  model's overall recommendation
                  performance across the evaluated
                  project data.
                </p>
              </div>
            </div>
            ...
            <div className="guide-card">
              ...
              <div>
                ...
                <p>
                  Indicates how often the predicted
                  formulation overlaps with the
                  reference formulation at the 50%
            ...
            <div className="guide-card">
              ...
              <div>
                ...
                <p>
                  A stricter ingredient-overlap
                  measure requiring a higher level
            ...
            <div className="guide-card">
              ...
              <div>
                ...
                <p>
                  Instead of returning one candidate,
                  the engine presents five ranked
                  formulation candidates for
                  comparison.
                </p>
              </div>
            </div>
